...
require (
	...
	github.com/hashicorp/consul-server-connection-manager v0.0.0-20220902220226-6a5359633f59
...
replace (
	github.com/hashicorp/consul-server-connection-manager v0.0.0-20220902220226-6a5359633f59 => ../../consul-server-connection-manager
)
